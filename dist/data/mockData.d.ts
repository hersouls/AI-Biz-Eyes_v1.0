...
export declare const generateITReferences: (count: number) => Reference[];
export declare const generateCTReferences: (count: number) => Reference[];
export declare const generateAIReferences: (count: number) => Reference[];
